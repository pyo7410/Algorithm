...
public class 재귀함수가뭔가요_17478 {
	...
	public static String[] chatbotRecur = {
	...
	public static void recur(int cnt, String s) {
		...
		if (cnt == n) {
			...
			for (int i = 0; i < chatbotRecur.length; ++i) {
				sb.append(s).append(chatbotRecur[i]).append("\n");
				//System.out.println(s + chatbotRecur[i]);
			}
